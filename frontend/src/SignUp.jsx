...
newErrors.confirmPassword="Your passwords didn't match"    }
    ...
    return (
        <div className='flex items-center flex-col mt-10 gap-5 '>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col border-1 border-black w-1/3 py-7 items-center gap-5 " action="">
                <div className='w-[90%]'>
               ...
               {success && <p className='text-green-600'>{success}</p>}
                <button type="submit" className='w-[90%] bg-purple-500  py-4 text-white rounded xl font-semibold cursor-pointer flex justify-center gap-1'><CircleUser /><p>Create Account </p> </button>
